 ...
 describe("GET /api/heros/", () => {
  ...
  describe("DELETE /api/heros/:heroId", () => {
    ...
    it("ALTERNATIVE should delete hero", async () => {
      ...
      const res = await request(app).delete(`/api/heros/507f191e810c19729de860ea`);
      expect(res.statusCode).toBe(404);
      expect(res.body.message).toBe('Not found');
  ...
  describe("UPDATE /api/heros/", () => {
    it("should update hero", async () => {
      ...
      const res = await request(app).patch(`/api/heros/${hero._id}`).send(updateHero);
  ...
  describe("UPDATE /api/heros/:heroId", () => {
    ...
    it("ALTERNATIVE should update hero", async () => {
      ...
      const res = await request(app).patch(`/api/heros/507f191e810c18729de860ea`).send(newhero);
      expect(res.statusCode).toBe(404);
      expect(res.body.message).toBe('Not found');
